...
form.addEventListener("submit", function (event) {
  ...
  if (password.value.length < 6 || passCheck.test(password.value) == false) {
    ...
    let err = document.createElement("li");
    err.innerText =
      "Le mot de passe ne peut pas être inférieur à 6 caractère et doit contenir au moins une majuscule, une minuscule, un nobre et un caractère spécial";
  ...
  if (
    ...
    //créer un <li></li> dans le HTML
    let err = document.createElement("li");
    err.innerText = "Les deux mot de passe doivent être identiques";
